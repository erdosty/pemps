...
clc;
% Opening Tiff File
Directory = 'C:\Users\erdost\Desktop\PHN Images for Analysis\Images2'; %degistir
mkdir Masks2
save_dir='C:\Users\erdost\Desktop\PHN Images for Analysis\Masks2'; %degistir
Folder=Directory;
files=dir(Directory);
goruntu="on";
%% Waitbar
